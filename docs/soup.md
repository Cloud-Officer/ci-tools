...
| Ruby | aws-partitions | 1.1287.0 | Apache-2.0 | Provides interfaces to enumerate AWS partitions, regions, and services. | <https://github.com/aws/aws-sdk-ruby> | 2026-09-21 | Low | Dependency | Dependency |
...
| Ruby | aws-sdk-ec2 | 1.651.0 | Apache-2.0 | Official AWS Ruby gem for Amazon Elastic Compute Cloud (Amazon EC2) | <https://github.com/aws/aws-sdk-ruby> | 2026-09-21 | Low | Access AWS services | Official AWS Ruby SDK |
...
| Ruby | aws-sdk-lambda | 1.196.0 | Apache-2.0 | Official AWS Ruby gem for AWS Lambda | <https://github.com/aws/aws-sdk-ruby> | 2026-05-22 | Low | Access AWS services | Official AWS Ruby SDK |
| Ruby | aws-sdk-ssm | 1.222.0 | Apache-2.0 | Official AWS Ruby gem for Amazon Simple Systems Manager (SSM) (Amazon SSM) | <https://github.com/aws/aws-sdk-ruby> | 2026-05-22 | Low | Access AWS services | Official AWS Ruby SDK |
...
| Ruby | bigdecimal | 4.1.3 | Ruby | This library provides arbitrary-precision decimal floating-point number class. | <https://github.com/ruby/bigdecimal> | 2026-09-14 | Low | Dependency | Dependency |
...
| Ruby | iniparse | 1.5.0 | MIT | A pure Ruby library for parsing INI documents | <http://github.com/antw/iniparse> | 2026-09-13 | Medium | Parse AWS credentials INI files for key rotation | Dormant upstream: no release or commit since 1.5.0 (2020-02-27). Accepted because the INI subset used (read profiles, replace two keys, save) is stable, no advisories are published (OSV), the version is pinned in Gemfile.lock, and no maintained Ruby INI alternative exists (inifile, parseconfig, iniparser, configparser and inih are also dormant) |
...
| Ruby | rubocop | 1.91.0 | MIT | RuboCop is a Ruby code style checking and code formatting tool. | <https://rubocop.org/> | 2026-05-22 | Low | Ruby linter | Most popular gem on rubygems |
...
| Ruby | simplecov | 1.3.0 | MIT | Code coverage for Ruby with a powerful configuration library and automatic merging of coverage across test suites | <https://github.com/simplecov-ruby/simplecov> | 2026-09-14 | Low | Code coverage reporting for RSpec test suite | Most popular Ruby code coverage tool with active maintenance |
...
| Ruby | unicode-emoji | 4.3.0 | MIT | [Emoji 18.0] Provides Unicode Emoji data and regexes, incorporating the latest Unicode and Emoji standards | <https://github.com/janlelis/unicode-emoji> | 2026-09-21 | Low | Dependency | Dependency |
